...
class ToggleScreen(Screen):
    def __init__(self, **kwargs):
        ...
        logout_button_box = ColoredBoxLayout(size_hint_y=None, height=50, background_color=(0.9, 0.7, 0.7, 1))
        ...
        submit_button = Button(text='Aggiorna', size_hint=(None, None), pos_hint={"right": 0.1, "top": 1}, width=200, height=50, background_color=(23/255, 7/255, 12/255, 1), color=(1, 1, 1, 1))
    ...
    def toggle_state(self, btn, idx):
        ...
        headers = {'User-Agent': 'MyKivyApp'}
        login_screen = self.manager.get_screen('login')
        response = login_screen.session.post(url, headers=headers, json=data)
        if response.status_code == 200:
            print(f"Button {idx+1} state updated successfully.")
        else:
            print(f"Failed to update state for button {idx+1}.")
...
class ToggleScreen(Screen):
    def __init__(self, **kwargs):
        ...
        submit_button.bind(on_press=self.submit_form)
        logout_button_box.add_widget(submit_button)
        add_button = Button(text='Aggiungi', size_hint=(None, None), pos_hint={"right": 0.1, "top": 1}, width=200, height=50, background_color=(23/255, 7/255, 12/255, 1), color=(1, 1, 1, 1))
...
class MainScreen(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        num_buttons_box = ColoredBoxLayout(orientation='horizontal', size_hint_y=None, height=80, background_color=(.2, 0.8, 0, 1))  # green
        float_layout = FloatLayout()
        num_buttons_label = Label(text="Number of Buttons:", color=(1, 0, 1, 1), font_size=34, size_hint=(None, None), size=(150, 50), pos_hint={'center_x': 0.2, 'center_y': 0.5})
        ...
        self.welcome_label = Label(text="Welcome, User", halign="center", font_size=44, color=(1, 0, 0, 1), size_hint_y=None, height=dp(50))
        ...
        submit_box = ColoredBoxLayout(orientation='horizontal', size_hint_y=None, height=dp(100), background_color=(0.7, 0.9, 0.7, 1))  # Adjust height if needed
        submit_label = Label(text="Toggle", color=(36/255, 253/255, 7/255, 1), font_size='20sp')  # Increase font size
        submit_button = Button(text='Toggle', size_hint=(None, None),pos_hint={"right":0.1,"top":1} , width=200, height=50, background_color=(23/255, 7/255, 12/255, 1), color=(1, 1, 1, 1))
        submit_button.bind(on_press=self.submit_form)
        ...
        submit_label = Label(text="Add new", color=(36/255, 253/255, 7/255, 1), font_size='20sp')  # Increase font size
        submit_button = Button(text='Add botton', size_hint=(None, None),pos_hint={"right":0.1,"top":1} , width=200, height=50, background_color=(23/255, 7/255, 12/255, 1), color=(1, 1, 1, 1))
        submit_button.bind(on_press=self.submit_form)
        submit_box.add_widget(submit_label)
        submit_box.add_widget(submit_button)
        ...
        toggle_label = Label(text=" Submit ", color=(36/255, 253/255, 7/255, 1), font_size='20sp')  # Increase font size
        #toggle_button = FluorescentToggleButton(text='Toggle')
        toggle_button = Button(text=' Submit ', size_hint=(None, None), width=200, height=50, background_color=(23/255, 7/255, 12/255, 1), color=(1, 1, 1, 1))
